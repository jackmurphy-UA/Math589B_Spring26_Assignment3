...
from .student import solve_continuous_are, solve_ivp
...
def build_model(
    ...
    # With viscosity gamma, the modal equations are
    # q'' + gamma q' + omega^2 q = beta b(t),
    # so the lower-right block is -gamma I.
    A = np.block(
        [
